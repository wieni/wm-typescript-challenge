...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). It is an example project created by Wieni, for TypeScript/React job applicants.
